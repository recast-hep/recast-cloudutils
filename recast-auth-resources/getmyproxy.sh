...
echo myproxy-logon -l lheinric -k "recast_$(echo `hostname`|sed 's|cern.ch||')" -n --voms atlas
myproxy-logon -l lheinric -k "recast_$(echo `hostname`|sed 's|cern.ch||')" -n --voms atlas
